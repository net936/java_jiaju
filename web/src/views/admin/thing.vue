      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="家具名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="颜色" name="color">
                  <a-input placeholder="请输入" v-model:value="modal.form.color" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="品牌" name="pinpai">
                  <a-input placeholder="请输入" v-model:value="modal.form.pinpai" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="材料" name="cailiao">
                  <a-input placeholder="请输入" v-model:value="modal.form.cailiao" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('color', modal.form.color || '');
        formData.append('guige', modal.form.guige || '');
        formData.append('pinpai', modal.form.pinpai || '');
        formData.append('cailiao', modal.form.cailiao || '');
