  ...
  <div>
    ...
    <section class="cart-page flex-view">
      <div class="left-flex">
        ...
        <div class="cart-list-view">
          ...
          <div class="list">
            <div class="items flex-view" v-for="item in pageData.gwc">
              ...
              <div style="width: 45px;text-align: center;">{{item.count}}</div>
            </div>
          </div>
        </div>
        ...
        <input v-model="pageData.receiverAddress" placeholder="请输入地址" class="name" />
      ...
      <div class="right-flex">
        ...
        <div class="price-view">
          <div class="price-item flex-view">
            <div class="item-name">家具总价</div>
            <div class="price-txt">¥{{ pageData.amount }}</div>
          </div>
          <div class="price-item flex-view">
            <div class="item-name">家具优惠</div>
            <div class="price-txt">¥0</div>
          </div>
          <div class="price-item flex-view">
            <div class="item-name">家具折扣</div>
            <div class="price-txt">¥0</div>
          </div>
